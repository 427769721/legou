...
<div class="panel_box row">
    <div class="panel col">
        <a href="javascript:;" data-url="${pageContext.request.contextPath}/page/message/message">
    ...
    <div class="panel col">
        <a href="javascript:;" data-url="${pageContext.request.contextPath}/page/user/allUsers">
    ...
    <div class="panel col">
        <a href="javascript:;" data-url="${pageContext.request.contextPath}/page/img/images">
    ...
    <div class="panel col">
        <a href="javascript:;" data-url="${pageContext.request.contextPath}/page/news/newsList">
