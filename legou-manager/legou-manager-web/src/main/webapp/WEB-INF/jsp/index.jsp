...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/lib/layui/lay/modules/jquery.js"></script>
...
<div class="container">
    ...
    <div class="logo">
        ...
        <img class="img" src="${pageContext.request.contextPath}/static/images/legou.png" width="60px" height="50px ">
        <%--<a href="./index">Legou</a>--%>
    </div>
    <div class="left_open">
